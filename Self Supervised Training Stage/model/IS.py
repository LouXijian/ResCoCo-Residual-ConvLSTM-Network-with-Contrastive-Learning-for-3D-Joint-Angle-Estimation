...
class Decoder(nn.Module):
    def __init__(self, hidden_size=64, sensor_num=2):
...
class Encoder(nn.Module):
    def __init__(self, seq_length, device, label_len, sensor_num=2, hidden_size=64, filter_size=3, conv_layer_num=7,
        ...
        self.ConvLSTM1 = ConvLSTM(seq_length, hidden_size, filter_size, device, feature_channel * 24, label_len,
                                  conv_layer_num, lstm_layer_num, feature_channel)
